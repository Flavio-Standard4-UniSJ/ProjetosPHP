...
<body>
    ...
    <?php 
        ...
        if (isset($_POST["pesquisar"])) {
            ...
            if ($artigo) {
                echo "<h2 class='h2'>" . $artigo['title'] . "</h2>";
                echo "<h3 class='h5'>" . $artigo['description'] . "</h5>";
                echo "<p style='text-align: justify;'>" . $artigo['content'] . "</p>";
            } else {
    ...
    <section>
        ...
        <form name="formuser" action="" method="POST">
            ...
            <input type="submit" name="pesquisar" class="btn btn-warning" onclick="return validar()" value="pesquisar">
        </form>
    </section>
